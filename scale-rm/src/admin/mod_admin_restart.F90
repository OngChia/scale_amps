...
contains
  ...
  subroutine ADMIN_restart_setup
    ...
    if( ierr < 0 ) then !--- missing
       LOG_INFO("ADMIN_restart_setup",*) 'Not found namelist. Default used.'
    ...
    ATMOS_PHY_LT_RESTART_OUTPUT = RESTART_OUTPUT
    ...
    ATMOS_PHY_BL_RESTART_OUTPUT = RESTART_OUTPUT
    ...
    if ( RESTART_IN_BASENAME /= '' ) then
       ...
       ATMOS_PHY_LT_RESTART_IN_BASENAME = RESTART_IN_BASENAME
       ...
       ATMOS_PHY_BL_RESTART_IN_BASENAME = RESTART_IN_BASENAME
    ...
    ATMOS_PHY_LT_RESTART_IN_AGGREGATE  = RESTART_IN_AGGREGATE
    ...
    ATMOS_PHY_BL_RESTART_IN_AGGREGATE  = RESTART_IN_AGGREGATE
    ...
    ATMOS_PHY_LT_RESTART_IN_POSTFIX_TIMELABEL  = RESTART_IN_POSTFIX_TIMELABEL
    ...
    ATMOS_PHY_BL_RESTART_IN_POSTFIX_TIMELABEL  = RESTART_IN_POSTFIX_TIMELABEL
    ...
    if ( RESTART_OUT_BASENAME /= '' ) then
       ...
       ATMOS_PHY_LT_RESTART_OUT_BASENAME = RESTART_OUT_BASENAME
       ...
       ATMOS_PHY_BL_RESTART_OUT_BASENAME = RESTART_OUT_BASENAME
    ...
    ATMOS_PHY_LT_RESTART_OUT_AGGREGATE  = RESTART_OUT_AGGREGATE
    ...
    ATMOS_PHY_BL_RESTART_OUT_AGGREGATE  = RESTART_OUT_AGGREGATE
    ...
    ATMOS_PHY_LT_RESTART_OUT_POSTFIX_TIMELABEL  = RESTART_OUT_POSTFIX_TIMELABEL
    ...
    ATMOS_PHY_BL_RESTART_OUT_POSTFIX_TIMELABEL  = RESTART_OUT_POSTFIX_TIMELABEL
    ...
    if ( RESTART_OUT_TITLE /= '' ) then
       ...
       ATMOS_PHY_LT_RESTART_OUT_TITLE = RESTART_OUT_TITLE
       ...
       ATMOS_PHY_BL_RESTART_OUT_TITLE = RESTART_OUT_TITLE
    ...
    if ( RESTART_OUT_DTYPE /= '' ) then
       ...
       ATMOS_PHY_LT_RESTART_OUT_DTYPE = RESTART_OUT_DTYPE
       ...
       ATMOS_PHY_BL_RESTART_OUT_DTYPE = RESTART_OUT_DTYPE
